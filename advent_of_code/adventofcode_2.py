""" Advent of Code exercise 2 """
""" In your expense report, what is the product of the three entries that sum to 2020? """


def find_three_entries(foo):
    ...
    print("Entries list:", str(entries))
    ...
    while n < len(sorted_entries):
        for i in sorted_entries:
            ...
            y = i
            z = 2020 - x - y
            if z in sorted_entries:
                print("\nFound! {} + {} + {} = {}".format(x, y, z, (x+y+z)))

                """ Multiply three entries. """

                print("\nThree entries multiplied: ", str((x*y*z)))
                break
            else:
                pass
