...
def read_in(data):
    ...
    for i in clean_list:
        first_split = i.split('-')
        lower.append(first_split[0])
        second_split = first_split[1].split(' ')
        upper.append(second_split[0])
    ...
    while n < len(passwords):
        letter_count = passwords[n].count(letters[n])
        if int(lower[n]) <= letter_count <= int(upper[n]):
            valid_count += 1
        n += 1
